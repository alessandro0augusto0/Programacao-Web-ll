...
$stmt = $conn->prepare("SELECT isbn, titulo, quantidadedisponivel, datapublicacao, status, genero, ideditora FROM cadastrolivro");
$stmt->execute();
...
<head>
    ...
    <title>Consulta de Livros - Bibliolink</title>
    <style>
        body {
...
<body>
    <div class="consulta-container">
        <h1>Consulta de Livros - Bibliolink</h1>
        <table>
            <thead>
                <tr>
                    <th>ISBN</th>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['quantidadedisponivel']); ?></td>
                        <td><?php echo htmlspecialchars($row['datapublicacao']); ?></td>
                        <td><?php echo htmlspecialchars($row['status']); ?></td>
                        <td><?php echo htmlspecialchars($row['genero']); ?></td>
                        <td><?php echo htmlspecialchars($row['ideditora']); ?></td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
        <form action="clientehome.php" method="get">
