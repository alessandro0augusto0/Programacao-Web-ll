...
$stmt = $conn->prepare("SELECT id, nome, email, telefone, cpf FROM usuariocliente");
$stmt->execute();
...
<head>
    ...
    <title>Consulta de Usuários - Bibliolink</title>
    <style>
        body {
...
<body>
    <div class="consulta-container">
        <h1>Consulta de Usuários - Bibliolink</h1>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
