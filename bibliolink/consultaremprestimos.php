...
$stmt = $conn->prepare("SELECT id, cpf, isbn, data_emprestimo FROM emprestimos");
$stmt->execute();
...
<head>
    ...
    <title>Consulta de Empréstimos - Bibliolink</title>
    <style>
        body {
...
<body>
    <div class="consulta-container">
        <h1>Consulta de Empréstimos - Bibliolink</h1>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
